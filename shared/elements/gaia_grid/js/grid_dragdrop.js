...
(function(exports) {
  ...
  function DragDrop(gridView) {
    ...
    this.container.addEventListener("keydown-app-uninstall",this);
  }
  ...
  DragDrop.prototype = {
    ...
    begin: function(e) {
      ...
      this.icon.scale = 1;//ACTIVE_SCALE;
    ...
    handleEvent: function(e) {
      switch(e.type) {
          ...
          case "keydown-app-uninstall":
            ...
            var index = this.gridView.items.indexOf(this.icon);
            this.gridView.items[index].remove();
            break;
