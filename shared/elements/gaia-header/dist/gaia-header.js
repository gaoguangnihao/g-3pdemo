! function (e) {
  if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
    ...
    var f;
    "undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.GaiaHeader = e()
  }
}(function () {
          ...
          define(function (require, exports, module) {
            ...
            module.exports = component.register('gaia-header', {
              ...
              created: function () {
                ...
                this.styleValueType = this.getAttribute('value-type');
              ...
              keyEventHandler: function (evt) {
                if (evt.key == KNOWN_KEYS[this._action]) {
                  //ignore system app.
              ...
              setTitleStyle: function (el, style) {
                ...
                this.observerStop();
                el.style.marginLeft = style.marginStart + (this.styleValueType ? this.styleValueType : 'px');
                el.style.paddingLeft = style.padding.start + (this.styleValueType ? this.styleValueType : 'px');
                el.style.paddingRight = style.padding.end + (this.styleValueType ? this.styleValueType : 'px');
              ...
              template: `<div class="inner tcl-inner">
