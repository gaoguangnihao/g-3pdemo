...
var TelephonyHelper = (function() {
  ...
  var call = function t_call(number, cardIndex, isVideo, oncall, onconnected,
    ...
    startDial(cardIndex, conn, sanitizedNumber, isVideo, oncall, onconnected,
              ondisconnected, onerror);
  };
  ...
  function startDial(cardIndex, conn, sanitizedNumber, isVideo, oncall,
    ...
    LazyLoader.load('/shared/js/icc_helper.js', function() {
      ...
      if (((cardState === 'unknown') || (cardState === 'illegal')) &&
        ...
        callPromise = telephony.dialVT(baseNumber, 4, cardIndex);
      } else {
