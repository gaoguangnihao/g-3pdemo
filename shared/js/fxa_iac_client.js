...
var FxAccountsIACHelper = function FxAccountsIACHelper() {
  ...
  var phoneVerification = function phoneVerification(successCb, errorCb) {
    sendMessage({
  ...
  var signOut = function signOut(email, successCb, errorCb) {
    sendMessage({
      'name': 'signOut',
      'email': email
    }, function(result) {
  ...
  var checkPassword = function checkPassword(email, title, successCb, errorCb) {
    sendMessage({
      'name': 'checkPassword',
      'email': email,
      'title': title,
  ...
  var changePassword = function changePassword(email, successCb, errorCb) {
    sendMessage({
      'name': 'changePassword',
      'email': email
    }, function(result) {
